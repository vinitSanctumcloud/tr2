...
// Define API object directly
const BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || 'https://api.tagwell.co/api';
const API = {
  AI_AGENT_DATA_FROM_SLUG: (slug: string) => {
...
const AI_AGENT_URL = process.env.NEXT_PUBLIC_AI_AGENT_URL || 'https://dev-ai-agent-api.golinka.com';
...
export default function AgentDetails() {
  ...
  useEffect(() => {
    ...
    const slug =  'jafar-agent-32663'; // Fallback to provided slug
      ...
      try {
        ...
        const activeResponse = await fetch(API.AI_AGENT_DATA_FROM_SLUG(slug), {
          ...
          headers: {
            ...
            // 'Authorization': `Bearer ${token}`, // Uncomment if token is available
          },
        });
